...
public class BatchTraitementDTO {
    ...
    public BatchTraitementDTO(Long id, String nomFichier, int nbrLigne, int nbrLigneValide, int nbrLigneInvalide, LocalDateTime startTime, LocalDateTime stopTime) {
        this.id = id;
