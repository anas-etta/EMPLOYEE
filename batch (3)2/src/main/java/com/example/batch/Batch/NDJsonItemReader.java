...
public class NDJsonItemReader implements ItemReader<EmployeeDTO> {
    ...
    private Set<String> emailsInCurrentFile = new HashSet<>();
    private Set<String> immatriculationsInCurrentFile = new HashSet<>();
    ...
    private String buildCustomErrorMessage(Exception e, String line, int lineNumber) {
        if (e instanceof JsonMappingException mappingException) {
            ...
            return "champs invalide (ligne : " + line + ")";
        } else if (e instanceof JsonParseException) {

            return "json invalide (ligne : " + line + ")";
        } else {

            return "erreur inconnue (ligne : " + line + ")";
        }
    }
